...
# setwd("C:/Users/ssmat/Desktop/Final_Project")
```
...
calls <- read.csv("EMScalls_cleaned.csv", stringsAsFactors = FALSE) %>%
...
VB_Census <-
  ...
  select(Total_Pop, Med_Inc, White_Pop,
         Med_Age,
         GEOID, geometry) %>%
...
![EMS Call Volume in Virginia Beach](HeatMapBetter.png) 
...
![Dispatch Stations in Virginia Beach, Symbolized by Ambulance Count](EMSCallsMap.png) 
